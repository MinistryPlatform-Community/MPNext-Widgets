...
export const PersonnelOrdinationSchema = z.object({
  ...
  Candidacy: z.iso.datetime().nullable(),
  Rite_Of_Lector: z.iso.datetime().nullable(),
  Rite_Of_Acolyte: z.iso.datetime().nullable(),
  Date_To_Priesthood: z.iso.datetime().nullable(),
  Religious_Order_ID: z.number().int().nullable(),
  Religious_Order_Status_ID: z.number().int().nullable(),
  Incardination_Date: z.iso.datetime().nullable(),
  ...
  Excardination_Date: z.iso.datetime().nullable(),
  Place_of_Excardination: z.string().max(100).nullable(),
  Date_of_Arrival: z.iso.datetime().nullable(),
  Date_of_Departure: z.iso.datetime().nullable(),
  Comments: z.string().max(2147483647).nullable(),
  Date_of_Deacon_Ordination: z.iso.datetime().nullable(),
  Priesthood_Date_of_Ordination: z.iso.datetime().nullable(),
  Priesthood_Ordained_Here: z.number().int().nullable(),
  Priesthood_Ordained_By: z.string().max(100).nullable(),
  Date_of_First_Profession: z.iso.datetime().nullable(),
  Date_of_Profession: z.iso.datetime().nullable(),
});
