...
export const ContactStagingSchema = z.object({
  ...
  Participant_Start_Date: z.iso.datetime().nullable(),
  ...
  Web_Page: z.url().nullable(),
  Anniversary_Date: z.iso.datetime().nullable(),
  ...
  Date_of_Death: z.iso.datetime().nullable(),
  _Contact_Setup_Date: z.iso.datetime().nullable(),
});
