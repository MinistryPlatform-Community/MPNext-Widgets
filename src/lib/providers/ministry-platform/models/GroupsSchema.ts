...
export const GroupsSchema = z.object({
  ...
  _Last_Attendance_Posted: z.iso.datetime().nullable(),
  _Last_Group_Member_Changed: z.iso.datetime().nullable(),
  ...
  Promotion_Date: z.iso.datetime().nullable(),
  ...
  Next_Scheduled_Meeting: z.iso.datetime().nullable(),
