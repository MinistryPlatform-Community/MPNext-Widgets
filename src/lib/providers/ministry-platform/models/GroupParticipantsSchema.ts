...
export const GroupParticipantsSchema = z.object({
  ...
  _First_Attendance: z.iso.datetime().nullable(),
  _Second_Attendance: z.iso.datetime().nullable(),
  _Third_Attendance: z.iso.datetime().nullable(),
  _Last_Attendance: z.iso.datetime().nullable(),
