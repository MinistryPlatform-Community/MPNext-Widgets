...
export const ParticipantsSchema = z.object({
  ...
  Participant_Start_Date: z.iso.datetime(),
  Participant_End_Date: z.iso.datetime().nullable(),
  Notes: z.string().max(1000).nullable(),
  _First_Attendance_Ever: z.iso.datetime().nullable(),
  _Second_Attendance_Ever: z.iso.datetime().nullable(),
  _Third_Attendance_Ever: z.iso.datetime().nullable(),
  _Last_Attendance_Ever: z.iso.datetime().nullable(),
  _Background_Check_Type: z.string().max(128).nullable(),
  _Background_Check_Status: z.string().max(50).nullable(),
  _Background_Check_Date: z.iso.datetime().nullable(),
