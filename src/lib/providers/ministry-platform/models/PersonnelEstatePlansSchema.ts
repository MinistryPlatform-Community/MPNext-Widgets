...
export const PersonnelEstatePlansSchema = z.object({
  ...
  Living_Will_Last_Updated: z.iso.datetime().nullable(),
  ...
  Power_of_Attorney_Date_Completed: z.iso.datetime().nullable(),
  Power_of_Attorney_Copy_to_PCP: z.boolean().nullable(),
  Power_of_Attorney_Agent_Has_Copy: z.boolean().nullable(),
  Will_Last_Updated_Date: z.iso.datetime().nullable(),
