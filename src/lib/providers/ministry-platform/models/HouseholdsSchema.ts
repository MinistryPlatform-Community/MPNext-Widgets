...
export const HouseholdsSchema = z.object({
  ...
  _First_Donation: z.iso.datetime().nullable(),
  _Last_Donation: z.iso.datetime().nullable(),
  _Last_Activity: z.iso.datetime().nullable(),
  Alternate_Mailing_Address: z.number().int().nullable(),
  Season_Start: z.iso.datetime().nullable(),
  Season_End: z.iso.datetime().nullable(),
