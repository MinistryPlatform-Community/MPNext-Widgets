/**
 * Promo-code validation endpoint for the next-event-details widget.
 * GET /api/embed/event-products/:productId/promo?promoCode=&editExistingPromoCode=&formId=&excludeInvoiceId=
 */
...
export async function GET(
  ...
  try {
    ...
    const editExistingPromoCode = sp.get("editExistingPromoCode") === "true";
    ...
    const promo = await service.validPromoCode(
      productId,
      promoCode,
      editExistingPromoCode,
      formId,
      excludeInvoiceId
    );
