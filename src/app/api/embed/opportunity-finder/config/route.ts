/**
 * Filter-dropdown configuration for the next-opportunity-finder widget.
 * GET /api/embed/opportunity-finder/config
 *   -> { congregations, ministries, genders, attributeTypes }
 */
...
import { OpportunityFinderService } from "@/services/opportunityFinderService";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("Error loading opportunity finder configuration:", error);
